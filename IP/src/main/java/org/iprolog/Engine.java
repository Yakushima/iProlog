    ...
    switch (t) {
      ...
      case R: { // reference
        ...
        for (int i = 0; i < n; i++) {
          ...
          Main.println("exportTerm(cell " + showCell(heap[j]) + ")="
                      + exportTerm(heap[j]).toString());
